...
public abstract class NineGridLayout extends ViewGroup {
    private String TAG = "WeChatMoment.NineGridLayout";
    ...
    private void refresh() {
        ...
        if (size == 1) {
            ...
            //避免一张图未加载成功时，布局高度受其他item影响
            LayoutParams params = getLayoutParams();
            params.height = mTotalWidth/2;
            mSingleWidth = mTotalWidth/2;
            Log.d(TAG,"mTotalWidth=="+mTotalWidth);
            Log.d(TAG,"params.height=="+params.height+"==params.width==="+params.width);
            Log.d(TAG,"mSingleWidth==="+mSingleWidth);
